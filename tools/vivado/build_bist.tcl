...
# generic DDR3_BIST_VIO=1 so that minimig_openaars_top instantiates vio_ddr3
# and the BIST can be driven over JTAG with tools/vivado/ddr3_bist.tcl.
...
# project defaults are HAVEDDR3=1, DDR3_BIST_VIO=0).
#
#   vivado -mode batch -source tools/vivado/build_bist.tcl -tclargs <report-dir> [<repo-root>]
#
...
set_property generic {DDR3_BIST_VIO=1} [get_filesets sources_1]
reset_run synth_1
...
puts "build_bist.tcl: DDR3_BIST_VIO generic cleared: '[get_property generic [get_filesets sources_1]]'"
puts "=== ALL DONE ==="
