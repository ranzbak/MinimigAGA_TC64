        ...
        if (rst) begin
            ...
            case (cpu_sm_state)
                ...
                CPU_SM_IDLE : begin
                    ...
                    if (cpu_cs) begin
                        if (cpu_we) begin
                            ...
                            if (cpu_bs[0])
                                cpu_cacheline_lo[cpu_adr_blk_ptr] <= #1 cpu_dat_w[ 7: 0]; //update low byte
                            if (cpu_bs[1])
                                cpu_cacheline_hi[cpu_adr_blk_ptr] <= #1 cpu_dat_w[15: 8]; //update hi byte
                        ...
                        else if (!cpu_cacheline_valid) begin
                ...
                if (cpu_cs) begin
                    ...
                    if (cpu_bs[0])
                        cpu_cacheline_lo[cpu_adr_blk]      <= #1 cpu_dat_w[ 7: 0]; //update low byte
                    if (cpu_bs[1])
                        cpu_cacheline_hi[cpu_adr_blk]      <= #1 cpu_dat_w[15: 8]; //update hi byte
                ...
                CPU_SM_READ : begin
                    ...
                    else if (cc_en && itag1_match && itag1_valid) begin
                    ...
                    else if (cc_en && dtag0_match && dtag0_valid) begin
                ...
                CPU_SM_FILL2 : begin
                    ...
                    else if (!cpu_cs | cpu_acked) begin
                        cpu_sm_state <= #1 CPU_SM_IDLE;
