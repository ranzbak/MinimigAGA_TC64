...
set_property CAPTURE_COMPARE_VALUE {eq32'h00BFXXXX} [pr $ila *tg68_adr*]
set_property TRIGGER_COMPARE_VALUE {eq32'h00BFXXXX} [pr $ila *tg68_adr*]
grab $ila ${pfx}_cia.csv "cia" 2
close_hw_manager
