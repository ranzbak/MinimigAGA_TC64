...
; Generated by mk_tint.py exc_m6 from ../../../lib/AP68040/tb/asm/t_exceptions.s -- do not edit
...
; (section 'FSAVE/FRESTORE' left out of the exc_m6 extract)
...
; (section 'trace' left out of the exc_m6 extract)
...
; (section 'PTEST/PFLUSH/CINV/CPUSH decode' left out of the exc_m6 extract)
...
; (block '; A full MC68040 does not recognize the LC/EC format-$4 frame.' left out of the exc_m6 extract)

; (block '; FRESTORE must reject a state frame with an incompatible version byte.' left out of the exc_m6 extract)
...
; (section 'interrupts' left out of the exc_m6 extract)

; (section 'M bit throwaway' left out of the exc_m6 extract)

; (section 'level-sensitive IPL: the NetBSD ports shape' left out of the exc_m6 extract)
