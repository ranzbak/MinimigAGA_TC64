...
// Local change (MinimigAGA_TC64): default grade only when none is given on the
// command line, so -Dsg7 / -Dsg5 do not ALSO enable the sg6 data-out block
// (two blocking #tAC waits per edge would exceed tCK and skip burst words).
`ifndef sg5
`ifndef sg7
