...
# Incorrect
set _xlnx_shared_i2 [get_pins -hier -regexp {openaars_virtual_top/sdram/cpu_cache/[id]dram[01]/.*}]
set _xlnx_shared_i3 [get_pins -hier -regexp openaars_virtual_top/sdram/cpu_cache/cpu_cacheline_.*]
set_multicycle_path -setup -from $_xlnx_shared_i2 -to $_xlnx_shared_i3 2
set_multicycle_path -hold -from $_xlnx_shared_i2 -to $_xlnx_shared_i3 1
...
set _xlnx_shared_i4 [get_pins -hier -regexp -nocase openaars_virtual_top/tg68k/pf68K_Kernel_inst/.*]
set_multicycle_path -setup -start -from [get_pins -hier -regexp -nocase openaars_virtual_top/tg68k/myakiko/c2p.myc2p/rdptr.*] -to $_xlnx_shared_i4 2
set_multicycle_path -hold -start -from [get_pins -hier -regexp -nocase openaars_virtual_top/tg68k/myakiko/c2p.myc2p/rdptr.*] -to $_xlnx_shared_i4 2
set _xlnx_shared_i5 [get_pins -hier -regexp -nocase openaars_virtual_top/tg68k/myakiko/c2p.myc2p/buf_reg.*]
set_multicycle_path -setup -start -from $_xlnx_shared_i5 -to $_xlnx_shared_i4 2
set_multicycle_path -hold -start -from $_xlnx_shared_i5 -to $_xlnx_shared_i4 2
...
create_pblock sdram
add_cells_to_pblock [get_pblocks sdram] [get_cells -quiet [list openaars_virtual_top/sdram]]
resize_pblock [get_pblocks sdram] -add {SLICE_X62Y51:SLICE_X89Y149}
resize_pblock [get_pblocks sdram] -add {DSP48_X2Y22:DSP48_X2Y59}
resize_pblock [get_pblocks sdram] -add {RAMB18_X2Y22:RAMB18_X3Y59}
resize_pblock [get_pblocks sdram] -add {RAMB36_X2Y11:RAMB36_X3Y29}

# Timing fix to signals to the SDRAM
# TODO find a better way to do this
set_max_delay 9.7 -from openaars_virtual_top/sdram/sdata_oe_reg/C