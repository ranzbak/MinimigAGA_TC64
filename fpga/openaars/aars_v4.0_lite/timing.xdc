...
create_generated_clock -name openaars_virtual_top/mycfide/sck_reg_n_0 -source [get_pins openaars_virtual_top/amiga_clk/amiga_clk_i/clk_main/CLKOUT1] -divide_by 8000 [get_pins openaars_virtual_top/mycfide/sck_reg/Q]
create_clock -period 35.799 -name VIRTUAL_dll_28_1 -waveform {0.000 17.900}
create_clock -period 5.000 -name VIRTUAL_clk_200_1 -waveform {0.000 2.500}
create_clock -period 640.000 -name VIRTUAL_my_i2s_transmitter/max_sclk_OBUF -waveform {0.000 320.000}
...
set_clock_groups -asynchronous -group [get_clocks -of_objects [get_pins openaars_virtual_top/amiga_clk/amiga_clk_i/clk_main/CLKOUT1]] -group [get_clocks VIRTUAL_dll_28_1]
set_clock_groups -asynchronous -group [get_clocks openaars_virtual_top/mycfide/sck_reg_n_0] -group [get_clocks -of_objects [get_pins openaars_virtual_top/amiga_clk/amiga_clk_i/clk_main/CLKOUT2]]
set_clock_groups -asynchronous -group [get_clocks openaars_virtual_top/mycfide/sck_reg_n_0] -group [get_clocks -of_objects [get_pins openaars_virtual_top/amiga_clk/amiga_clk_i/clk_main/CLKOUT1]]
...
set_false_path -to [list [get_ports dv_*] [get_ports js_*] [get_ports uart3_*] [get_ports pmod_*] [get_ports sd_m_*] [git_ports led_*]]
set_false_path -from [list [get_ports pmod_*] [get_ports *sd_m_*] [get_ports *button*] [get_ports *reset*] [get_ports *dv_s*]]

# Input delay
set_input_delay -clock [get_clocks VIRTUAL_dll_28_1] -min -add_delay 1.000 [get_ports dv_s*]
set_input_delay -clock [get_clocks VIRTUAL_dll_28_1] -max -add_delay 1.600 [get_ports dv_s*]
...
# Output delay
set_output_delay -clock [get_clocks VIRTUAL_clk_200_1] -min -0.700 [get_ports -filter { NAME =~  "*dv_*" && DIRECTION != "IN" }]
set_output_delay -clock [get_clocks VIRTUAL_clk_200_1] -max 1.000 [get_ports -filter { NAME =~  "*dv_*" && DIRECTION != "IN" }]
set_output_delay -clock [get_clocks VIRTUAL_dll_28_1] -min -add_delay -100.000 [get_ports js_*]
set_output_delay -clock [get_clocks VIRTUAL_dll_28_1] -max -add_delay 100.000 [get_ports js_*]
set_output_delay -clock [get_clocks VIRTUAL_dll_28_1] -min -add_delay -2.000 [get_ports led_*]
set_output_delay -clock [get_clocks VIRTUAL_dll_28_1] -max -add_delay 2.000 [get_ports led_*]
set_output_delay -clock [get_clocks VIRTUAL_my_i2s_transmitter/max_sclk_OBUF] -clock_fall -min -add_delay -900.000 [get_ports max_*]
...
set_output_delay -clock [get_clocks VIRTUAL_dll_28_1] -min -add_delay -0.900 [get_ports pmod_*]
set_output_delay -clock [get_clocks VIRTUAL_dll_28_1] -max -add_delay 1.200 [get_ports pmod_*]
set_output_delay -clock [get_clocks VIRTUAL_dll_28_1] -min -add_delay -1.000 [get_ports ps2_*]
set_output_delay -clock [get_clocks VIRTUAL_dll_28_1] -max -add_delay 1.000 [get_ports ps2_*]
set_output_delay -clock [get_clocks VIRTUAL_dll_28_1] -min -add_delay -5.000 [get_ports uart*]
set_output_delay -clock [get_clocks VIRTUAL_dll_28_1] -max -add_delay 5.000 [get_ports uart*]
...
# Multi cycle paths
set_multicycle_path -setup -from [get_clocks -of_objects [get_pins openaars_virtual_top/amiga_clk/amiga_clk_i/clk_main/CLKOUT1]] -to [get_clocks VIRTUAL_dll_28_1] 4
set_multicycle_path -hold -from [get_clocks -of_objects [get_pins openaars_virtual_top/amiga_clk/amiga_clk_i/clk_main/CLKOUT1]] -to [get_clocks VIRTUAL_dll_28_1] 3
...
set_multicycle_path -setup -start -from [get_clocks -of_objects [get_pins openaars_virtual_top/amiga_clk/amiga_clk_i/clk_main/CLKOUT1]] -to [get_clocks clk_sdram] 2
set_multicycle_path -hold -start -from [get_clocks -of_objects [get_pins openaars_virtual_top/amiga_clk/amiga_clk_i/clk_main/CLKOUT1]] -to [get_clocks clk_sdram] 1
