...
set_property PULLTYPE PULLUP [get_ports ps2_clk1]
set_property PULLTYPE PULLUP [get_ports ps2_clk2]
set_property PULLTYPE PULLUP [get_ports ps2_data1]
set_property PULLTYPE PULLUP [get_ports ps2_data2]
