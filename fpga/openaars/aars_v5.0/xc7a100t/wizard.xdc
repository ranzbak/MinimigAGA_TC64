...
set_multicycle_path -setup 1 -from [get_cells -quiet {openaars_virtual_top/minimig/cpu_config_reg_reg[0]}] -to [get_cells -quiet {openaars_virtual_top/tg68k/g_tg68k.pf68K_Kernel_inst/use_VBR_Stackframe_reg}]
set_multicycle_path -hold  0 -from [get_cells -quiet {openaars_virtual_top/minimig/cpu_config_reg_reg[0]}] -to [get_cells -quiet {openaars_virtual_top/tg68k/g_tg68k.pf68K_Kernel_inst/use_VBR_Stackframe_reg}]
