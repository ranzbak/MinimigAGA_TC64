...
# UART 0 interface
set_property -dict {PACKAGE_PIN AB24 IOSTANDARD LVTTL} [get_ports uart0_rxd]
set_property -dict {PACKAGE_PIN W25 IOSTANDARD LVTTL} [get_ports uart0_txd]
...
set_property -dict {PACKAGE_PIN Y25 IOSTANDARD LVTTL} [get_ports uart1_rxd]
set_property -dict {PACKAGE_PIN AC24 IOSTANDARD LVTTL} [get_ports uart1_txd]
